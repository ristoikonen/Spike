...
From (https://www.microsoft.com/net/learn/apps/machine-learning-and-ai/ml-dotnet) to detect **spikes**.
In the world of machine learning, this type of task is called TimeSeries Anomaly Detection.
